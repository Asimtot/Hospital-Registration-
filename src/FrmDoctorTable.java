 ...
 * @author yusuf
 */
public class FrmDoctorTable extends javax.swing.JFrame {

    /**
     * Creates new form FrmDoctorTable
     */
    public FrmDoctorTable() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDoctorTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDoctorTable().setVisible(true);
            }
        });
    }
